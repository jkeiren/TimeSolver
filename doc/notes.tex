...
For timed automata, these two are equivalent. This can be seen from the following derivation.
\begin{align*}
...
\]
with sidecondition $\placeholder \implies \bigwedge_{i=1}^n \placeholder[n]$.
