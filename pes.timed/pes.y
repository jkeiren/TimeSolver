...
%{ 
  ...
  extern int add_clock(char *s);
  extern int add_atomic(char *s);
  extern int add_atomicv(char *s, int i);
  extern int add_predicate(char *s, int i);
  extern int add_equation(int block, bool parity, char *s, ExprNode *);
  extern int lookup_clock(char *s);
  extern ExprNode * lookup_predicate(char *s);
  extern ExprNode * lookup_equation(char *s);
  extern int yyline;
